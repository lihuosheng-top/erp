  ...
  <div id="col-main">
    <div id="main-hd" class="cf">
      ...
      <ul class="user-menu">
      	...
      	<li class="space">|</li>-->
      	<li class="qq" style="display:none;"><a href="" onClick="return false;" id="wpa">QQ咨询：93138905</a></li>
      	<li class="space" style="display:none;">|</li>
        
      	<li class="telphone" style="display:none;">电话：17701030513</li>
        <li class="space" style="display:none;">|</li>
      	<li style="display:none;"><a href="http://www.istheme.com/i/253" target="_blank" class="buy-now">购买</a></li>
        <li class="space"style="display:none;">|</li>
      	<li id="sysSkin" style="display:none;">换肤</li>
        <li class="space" style="display:none;">|</li>
        
      	<li><a class="service-tab" data-tab="3" style="display:none;">在线提问</a></li>
		<li class="space" style="display:none;">|</li>
        <!-- 
